...
const Combobox = React.forwardRef(
  (
    { list, value, onChange, placeholder = "Select Item", className, multiple = false },
    ref
  ) => {
    ...
    const displayValue = () => {
      ...
      return value ? list.find((item) => item.value === value)?.label : placeholder;
    };
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            className={cn(
              "w-full justify-between font-normal hover:bg-popover",
              className
            )}
